...
export default function About() {
  ...
  return (
    ...
    Welcome to my professional portfolio. I am a skilled software developer driven by a profound passion for crafting exquisite and highly {" "}
        ...
        . I am also familiar with Python Development . I am always looking to
        learn new technologies. I am currently looking for a{" "}
        <span className="font-medium">full-time position</span> as a software
        developer.
    </p>
    <p>
    <span className="italic">When I'm not coding</span>, Reading Books , watching movies,Travelling,Dancing. I also enjoy{" "}
